...
await leapwork.step("Post packing slip Sales Order", async () => {
    await postingASalesOrder(page);
}, { action: "custom" });
// ai-studio-step-id: pw1v4t43w0
await leapwork.step("Invoice Sales Order", async () => {
    await invoiceSalesOrder(page);
}, { action: "custom" });

// ai-studio-step-id: dd600b8d
