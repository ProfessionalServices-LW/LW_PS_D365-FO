...
// ai-studio-step-id: pwpx30tb00
await leapwork.step("Convert To Customer", async () => {
   
    await convertToCustomer(page);
 
}, { action: "custom" });

// ai-studio-step-id: pwgok2ky00
await leapwork.step("Confirm Sales Quotation", async () => {
    await confirmSalesQuotation(page);
}, { action: "custom" });
// ai-studio-step-id: pwm64vtj00
